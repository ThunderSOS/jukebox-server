...
public class FileList {
  ...
  public FileList(RemoteDirectory remote, String subDirectory, List<String> exclude, JBFilenameFilter filter) throws FileNotFoundException {  
